 ...
 */
public class TextOnlyFragment extends Fragment implements TextOnlyAdapter.TextOnlyPresenter{

    private RecyclerView mRecyclerView;
    private TextOnlyAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new TextOnlyAdapter(getContext());
